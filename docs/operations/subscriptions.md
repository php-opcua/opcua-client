...
<!-- @method name="$client->createSubscription(float \$publishingInterval = 500.0, int \$lifetimeCount = 2400, int \$maxKeepAliveCount = 10, int \$maxNotificationsPerPublish = 0, bool \$publishingEnabled = true, int \$priority = 0): SubscriptionResult" returns="SubscriptionResult" visibility="public" -->
...
<!-- @params -->
<!-- @param name="$publishingInterval" type="float" default="500.0" -->
...
alive without a publish request. Default of 2400 × 500 ms = 20 min.
<!-- @endparam -->
...
<!-- @endparam -->
<!-- @param name="$publishingEnabled" type="bool" default="true" -->
