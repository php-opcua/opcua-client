 ...
 */
class TranslateBrowsePathModule extends ServiceModule
{
    ...
    {
        $this->client->registerMethod('translateBrowsePaths', $this->translateBrowsePaths(...));
        $this->client->registerMethod('resolveNodeId', $this->resolveNodeId(...));
    }
    ...
    public function resolveNodeId(string $path, NodeId|string|null $startingNodeId = null, bool $useCache = true): NodeId
    {
        ...
        $cacheKey = $this->kernel->buildCacheKey('resolve', $startingNodeId, md5($normalizedPath));
